...
int main(int argc, const char* argv[])
{
    ...
    simpleObject    object1("object_1");
    simpleObject    object2("object_2");

    object1.add_point( -10, -10, -10 );
    object1.add_point( -10,  10, -10 );
    object1.add_point(  10,  10, -10 );
    object1.add_point(  10, -10, -10 );

    object2.add_point( -10, -10,  10 );
    object2.add_point( -10,  10,  10 );
    object2.add_point(  10,  10,  10 );
    object2.add_point(  10, -10,  10 );
    ...
    printf("moving object2 by 0, 0, -20...\n");
    object2.translate( 0, 0, -20 );
    ...
    complexObject    object3( "object_3", 8, 0.5 );
